...
<div className="container-xxl flex-grow-1 container-p-y">
    <h4 className="fw-bold mb-3">
        <span className="text-muted fw-light"> Dashboard / @(Model.Type)s </span> / @Model.Type Details
    </h4>

    <div className="card">
        <div className="card-header d-flex">
            <h5 className="mx-auto my-3"><strong className="fon">@Model.Type Details</strong></h5>
                ...
                <div className="row">
                    <div className="col-md-5">
                        ...
                        <div className="d-flex btn-group mx-4">
                                ...
                                <a className="btn btn-warning" href="/Residences/Edit?Id=@Model.Id">
                    ...
                    <div className="col-md-7 border border-3 border-top-0 rounded-bottom">
                        ...
                        <div className="mb-3">
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-3">Price @Model.PriceType:</div>
