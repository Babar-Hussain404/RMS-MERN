...
<h4 class="fw-bold mb-3">
    <span class="text-muted fw-light"> Dashboard / @(Model.Type)s </span> / Delete @Model.Type
</h4>

<div class="card">
    <div class="card-header d-flex">
        <h5 class="mx-auto my-3"><strong class="text-danger">Are you Sure You want to Delete this @Model.Type?</strong></h5>
            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="d-flex btn-group mx-4">
                            ...
                            <a class="btn btn-danger" href="/Residences/DeleteConfirm?Id=@Model.Id">
