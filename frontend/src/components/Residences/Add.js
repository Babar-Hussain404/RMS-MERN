...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold mb-3"><span class="text-muted fw-light">Residences /</span> Add Residence</h4>

    <div class="card">
        <div class="card-header d-flex">
            <h5 class="mx-auto my-3"><strong> ADD NEW RESIDENCE </strong></h5>
        ...
        <div class="card-body">
            <form asp-action="AddResidence" id="sub" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <div class="mb-3">
                        <label class="form-label" for="basic-icon-residence-facilities">Select Facilities</label>

                        <div class="row">

                                <div class="col-md-4">
                                    <div class="form-check form-switch mb-2">
                                        <input class="form-check-input check" type="checkbox" name="Facilities[@i].IsSelected" id="Facility_@i" value="true" />
                                        ...
                                        <label class="form-check-label btn btn-outline-primary w-100 text-start" for="Facility_@i">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="file" asp-for="ResidenceImage" />
